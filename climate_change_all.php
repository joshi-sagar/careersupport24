...
echo "<h1>All Publication Related to Climate Change</h1>";

 echo"<div class='scrollable'>";
$result= mysql_query ("select * from library where category = 'Climate_Change' and status='0' order by it desc");
