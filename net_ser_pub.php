...
$id3=$_REQUEST['country2'];


echo "<h1>Publication Related to: $id3 under main category: $id3 </h1>";

 echo"<div class='scrollable'>";
$result= mysql_query ("select * from library where category= '$id2' and Area= '$id3' and status='0' order by it desc");
