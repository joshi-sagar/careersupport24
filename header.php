...
<div class="wrapper row2">
 ...
 <li ><a class="drop" href="#">Entry</a>
          <ul>
		   <li><a href="Add_user_type.php">Add_user_type</a></li>
		   <li><a href="Add_user.php">Add System User</a></li> 
		  
		  
    <li><a href="Add_city.php">Add City</a></li> 
            <li><a href="Add_franchise.php">Add Franchisee</a></li> 

            <li><a href="Add_vehicle_aggrement.php">Add Vehicle</a></li> 
...
<li><a href="vehicle_aggrement.php">Aggrement</a></li> 
...
<li><a href="main_report.php">BALANCE REPORT</a>
    ...
    <li><a class="drop" href="#">Settings</a> 


<ul>     

 <li><a href="upload.php">Upload Documents</a></li>
 <li><a href="db.php">System Database Backup</a></li>

<li><a href="rate_calculator_entry.php">Rate Calculate Entry</a></li>
 <li><a href="rate_calculate.php">Rate Calculate</a></li>
 
<li><a href="vehicle_detail_find.php">Vehicle Details Search</a></li>
 </ul></li> 
