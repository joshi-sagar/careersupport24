...
$result= mysql_query ("select * from species_bank where category= '$id2' and status= '0' order by id desc");
...
echo "<tr><th>Species Name</th><th>Lat/Long</th><th>Accession No</th>     <th>Species Locality</th><th>Species Elevation</th><th>Digital Herbarium</th><th>Upload Date</th><th>Uploaded By</th></tr>";

while($row=mysql_fetch_array($result))
{

   echo "<tr><td>$row[2]</td><td>$row[4]</td><td>$row[6]</td><td>$row[3]</td><td>$row[7]</td><td ><a href=  $row[8] target= '_blank' >  $row[2]  </a></td><td> $row[11] </td><td><a href=member_profile.php?id2=$row[9] >$row[9]</a></td></tr>" ;}
